...
export default function LoginPage() {
  ...
  // usePostData for login
  const { mutate: login, isLoading } = usePostData<
    { data: any; message: string; others: { token: string } },
    Error,
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 to-purple-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <p className="text-lg text-white/90 mb-8">
            Join thousands of users who are already using our platform to grow their business.
          </p>
